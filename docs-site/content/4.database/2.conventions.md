...
| `visual_description_scene_<sceneId>` | text | `ensureVisualDescriptions` (visual-description step) | image_prompt + video_prompt handlers (internal; not exposed via API) |
| `visual_style_anchor` | text | `ensureVisualDescriptions` | image_prompt + video_prompt handlers (project-level, one row; internal) |
