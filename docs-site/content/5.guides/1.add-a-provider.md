...
description: "Step-by-step guide for adding an AI provider integration."
---
...
Rules (see [providers.md](/backend/providers) for why):
...
- Update the provider inventory table in [providers.md](/backend/providers).
