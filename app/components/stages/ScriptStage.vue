      ...
      <div class="flex items-end gap-4">
        <div class="flex flex-col gap-1.5 w-48">
          ...
          <select
            ...
            v-model="tone"
            :disabled="isRunning"
            class="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-sm text-white focus:outline-none focus:ring-1 focus:ring-white/20 disabled:opacity-50"
          >
